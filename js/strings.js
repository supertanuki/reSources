...
const STRINGS = {
  en: {
    ...
    alert_basin_unlock:   'You can collect water to have some available.\nClick "Collect Water" to create a basin.',
    ...
    stats_trees:           'Trees',
    stats_trees_cut:       'Trees cut',
    stats_trees_planted:   'Trees planted',
    stats_population:      'Population',
    stats_deaths:          'Deaths',
    stats_houses:          'Shelters',
    stats_gardens:         'Gardens',
    stats_harvests:        'Harvests',
    stats_lost_harvests:   'Lost harvests',
    alert_build_water_crisis: 'Building a new shelter is not possible,\nwe are in a water crisis!',
    alert_build_limit:    'You need at least one farmland per shelter.\nCreate more gardens before building a new shelter.',
    alert_starvation:     'Your community did not have enough food.\nHarvest regularly to feed your inhabitants.',
  ...
  fr: {
    ...
    alert_basin_unlock:   "Vous pouvez collecter de l'eau pour pouvoir en avoir un peu à disposition.\nCliquer sur Collecter eau pour créer un bassin.",
    ...
    stats_trees:           'Arbres',
    stats_trees_cut:       'Arbres coup\u00e9s',
    stats_trees_planted:   'Arbres plant\u00e9s',
    stats_population:      'Population',
    stats_deaths:          'D\u00e9c\u00e8s',
    stats_houses:          'Maisons',
    stats_gardens:         'Potagers',
    stats_harvests:        'R\u00e9coltes',
    stats_lost_harvests:   'R\u00e9coltes perdues',
    alert_build_water_crisis: "Il n'est pas possible de construire de nouvel abri,\nnous sommes en état de crise hydrique !",
    alert_build_limit:    "Il vous faut au moins un potager par abri.\nCréez plus de potagers avant de construire un nouvel abri.",
    alert_starvation:     "Votre communauté manque de nourriture.\nRécoltez régulièrement pour nourrir vos habitants.",
